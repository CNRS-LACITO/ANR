...
<!--PARTIE TRAITEMENT ET AFFICHAGE. APPELE POUR CHAQUE TEXTE-->
...
<tr>
<xsl:choose>
<xsl:when test="(document($filesim)//similarities/similarity/file[@id=$file]/sentence[@id=$id_s]) and (((document($filesim)//similarities/similarity[@id=]/file[@id=$file1]) and (not ($file1=$file))) or ((document($filesim)//similarities/similarity/file[@id=$file2]) and (not ($file2=$file))) or ((document($filesim)//similarities/similarity/file[@id=$file3]) and (not ($file3=$file))) or ((document($filesim)//similarities/similarity/file[@id=$file4]) and (not ($file4=$file))) or ((document($filesim)//similarities/similarity/file[@id=$file5]) and (not ($file5=$file))) or ((document($filesim)//similarities/similarity/file[@id=$file6]) and (not ($file6=$file))))">

...
<tr>
<xsl:choose>
<xsl:when test="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f1_xml]/sentence[@id=$id_s]">
<xsl:variable name="num_sim" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f1_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/@id"/>
<xsl:variable name="similarity" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f1_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/@id"/>
<xsl:variable name="color" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f1_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/color"/>
...
<!--<xsl:call-template name="player-audio_wav_file2">
<xsl:with-param name="f2_sound" select="$f2_sound"/>
<xsl:with-param name="f2_xml" select="$f2_xml"/>
</xsl:call-template>-->
...
<tr>
<xsl:choose>
<xsl:when test="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f2_xml]/sentence[@id=$id_s]">
<xsl:variable name="num_sim" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f2_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/@id"/>
<xsl:variable name="similarity" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f2_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/@id"/>
<xsl:variable name="color" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f2_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/color"/>
<td class="segmentContent" width="600px" bgcolor="{$color}">
<a href="#" onClick="window.open('ViewOneSimilarity.php?similarity={$similarity}&amp;color={$color}','Fiche','toolbar=no,status=no,width=900 ,height=600,scrollbars=yes,location=no,resize=yes,menubar=yes')">
<p><b>Similarity <xsl:value-of select="$num_sim"/></b><br/></p>
</a>
...
<!--<xsl:call-template name="player-audio_wav_file3">
<xsl:with-param name="f3_sound" select="$f3_sound"/>
<xsl:with-param name="f3_xml" select="$f3_xml"/>
</xsl:call-template>-->
...
<tr>
<xsl:choose>
<xsl:when test="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f3_xml]/sentence[@id=$id_s]">
<xsl:variable name="num_sim" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f3_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/@id"/>
<xsl:variable name="similarity" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f3_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/@id"/>
<xsl:variable name="color" select="document('SIMILARITIES.xml')//similarities/similarity/file[@id=$f3_xml]/sentence[@id=$id_s]/parent::node()/parent::node()/color"/>
<td class="segmentContent" width="600px" bgcolor="{$color}">
<a href="#" onClick="window.open('ViewOneSimilarity.php?similarity={$similarity}&amp;color={$color}','Fiche','toolbar=no,status=no,width=900 ,height=600,scrollbars=yes,location=no,resize=yes,menubar=yes')">
<p><b>Similarity <xsl:value-of select="$num_sim"/></b><br/></p>
</a>
